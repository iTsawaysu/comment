...
public class ShopController {
     ...
     */
    @GetMapping("/of/name")
    public CommonResult<List<Shop>> queryShopByName(@RequestParam(value = "name", required = false) String name,
                                                    @RequestParam(value = "current", defaultValue = "1") Integer current) {
